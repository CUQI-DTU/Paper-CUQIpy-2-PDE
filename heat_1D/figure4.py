...
lci = samples2.burnthin(Nb,Nt).plot_ci(95, plot_par=True)#, exact=x_exact)
lci[0].set_label("95% CI")
#lci[1].set_label("Exact")
lci[2].set_label("Mean")
plt.legend()
...
lci = samples10.burnthin(Nb,Nt).plot_ci(95, plot_par=True)#, exact=x_exact)
lci[0].set_label("95% CI")
#lci[1].set_label("Exact")
lci[2].set_label("Mean")
plt.legend()
...
lci = samples13.burnthin(Nb,Nt).plot_ci(95, plot_par=True)#, exact=x_exact)
lci[0].set_label("95% CI")
#lci[1].set_label("Exact")
lci[2].set_label("Mean")
plt.legend()
