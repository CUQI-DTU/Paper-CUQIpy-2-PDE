...
posterior = cuqi.distribution.JointDistribution(prior,data_dists[0],data_dists[1],data_dists[2],data_dists[3])(y1=data[0], y2=data[1], y3=data[2], y4=data[3])._as_stacked()
...
samples = Sampler.sample_adapt(1000000)
